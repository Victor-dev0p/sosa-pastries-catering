...
export default function GalleryPage() {
  ...
  const galleryImages = [
    ...
    { src: "/services/Naked1.jpg", title: "Garden Wedding Cake", height: 320 },
    ...
    { src: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&h=300", title: "Classic White Tiered", height: 200 },
    { src: "https://images.unsplash.com/photo-1535254973040-607b474cb50d?w=400&h=400", title: "Rustic Naked Cake", height: 250 },
    { src: "/services/Naked.jpg", title: "Garden Wedding Cake", height: 320 },
    { src: "https://images.unsplash.com/photo-1571115177098-24ec42ed204d?w=400&h=350", title: "Anchor Theme Design", height: 220 },
    { src: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400&h=300", title: "Outdoor Naked Cake", height: 200 },
    { src: "https://images.unsplash.com/photo-1618897996318-5a901fa6ca71?w=400&h=600", title: "Rustic Display Setup", height: 350 },
    { src: "https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=400&h=400", title: "Simple White Elegance", height: 240 },
  ...
  return (
    <PageWrapper>
      <div className="min-h-screen bg-white mb-30">
        {/* 1. GALLERY HEADER */}
        <div className="py-16 px-4 md:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-serif font-semibold text-[#3A2E2E] mb-3">
              Our Gallery
            </h1>
            <p className="text-[#3A2E2E] max-w-2xl mx-auto text-sm md:text-base">
            ...
            <div className="columns-2 md:columns-3 lg:columns-4 gap-3 md:gap-4">
              {shuffledImages.map((item, index) => (
                ...
                >
                  ...
                  {/* Hover Title */}
                  <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-t from-[#FA812F]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        <AnimatePresence>
          {selected && currentIndex !== null && (
            ...
            >
              ...
              >
                <h3 className="text-white text-base md:text-xl font-medium bg-[#FA812F]/80 inline-block px-4 md:px-6 py-2 md:py-3 rounded-lg">
                  {selected.title}
                </h3>
              </motion.div>
            </motion.div>
