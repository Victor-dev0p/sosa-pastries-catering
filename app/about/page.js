...
export default function AboutPage() {
  return (
    <PageWrapper>
    <main className="bg-white text-[#3A2E2E]">
      {/* HERO SECTION */}
      ...
      <section className="max-w-6xl mx-auto py-20 px-6 flex flex-col lg:flex-row items-center gap-12">
        <motion.div
          ...
          className="lg:w-1/2"
        >
          <h2 className="text-3xl font-serif font-bold mb-4 text-[#3A2E2E]">The Heart Behind Sosa</h2>
          <p className="text-[#3A2E2E] leading-relaxed mb-4">
            Founded from a love for food and togetherness, <span className="font-semibold text-[#FA812F]">Sosa Catering</span> began as a small home-based kitchen passionate about creating
      ...
      <section className="bg-[#FFF8E7] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-3xl font-serif font-bold mb-10 text-[#3A2E2E]"
          >
            What We Offer
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-white shadow-md p-8 rounded-lg border-2 border-[#F9B233]/20 hover:border-[#FA812F] transition-colors"
              >
                <h3 className="text-xl font-semibold mb-3 text-[#FA812F]">
                  {item.title}
                </h3>
                <p className="text-[#3A2E2E] leading-relaxed">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto py-20 px-6 text-center">
        <motion.h2
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-3xl font-serif font-bold mb-8 text-[#3A2E2E]"
        >
          Our Promise
        </motion.h2>
        <p className="max-w-3xl mx-auto text-[#3A2E2E] mb-10 leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-[#FA812F] font-medium">
          <span className="bg-[#FFF8E7] px-6 py-3 rounded-full shadow-sm border-2 border-[#F9B233]/30">
            Fresh Ingredients
          </span>
          <span className="bg-[#FFF8E7] px-6 py-3 rounded-full shadow-sm border-2 border-[#F9B233]/30">
